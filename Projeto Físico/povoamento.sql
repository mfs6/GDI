...
INSERT INTO MEMBRO(NOME_PESSOA, NOME_GANGUE) VALUES
    ('Claude Speed', 'Cartel Colombiano'),
    ('Claude Speed', 'Máfia Italiana'),
    ('Claude Speed', 'Yakuza'),
    ('Catalina', 'Cartel Colombiano'),
    ('Asuka Kasen', 'Yakuza'),
    ('Kenji Kasen', 'Yakuza'),
    ('Salvatore Leone', 'Máfia Italiana'),
    ('Toni Cipriani', 'Máfia Italiana'),
    ('Lee Chong', 'Tríades'),
    ('Cisco', 'Cartel Colombiano'),
    ('Miguel', 'Cartel Colombiano'),
    ('Luigi Goterelli', 'Máfia Italiana');
